...
public class session2 extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference("Section 2"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference session = _firebase.getReference("  Section 2"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    if (b1.isChecked()) {
                        ...
                        map.put("session","2");
                        Toast.makeText(session2.this, "Submitted", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(session2.this, sections.class);
                    startActivity(i);
                }
            }
        });
