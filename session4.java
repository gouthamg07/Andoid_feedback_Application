...
public class session4 extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference("Section 4"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference session = _firebase.getReference("  Section 4"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    if (b1.isChecked()) {
                        ...
                        map.put("session","4");
                        Toast.makeText(session4.this, "Submitted", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(session4.this, sections.class);
                    startActivity(i);
                }
            }
        });
