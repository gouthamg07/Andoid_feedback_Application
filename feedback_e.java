...
public class feedback_e extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference(" Finance"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference section = _firebase.getReference("  Finance"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference course = _firebase.getReference(" Finance"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    if (b1.isChecked()) {
                        ...
                        map.put("section", "A");
                        Toast.makeText(feedback_e.this, "Submitted", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(feedback_e.this, sections.class);
                    startActivity(i);
                }
            }
        });
