...
public class C extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference("C section"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference section = _firebase.getReference("C section "+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference course = _firebase.getReference("C section"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    if (b1.isChecked()) {
                        ...
                        map.put("section", "C");
                        Toast.makeText(C.this, "Submitted", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(C.this, sections.class);
                    startActivity(i);
                }
            }
        });
