...
public class session1 extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference("Section 1"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference session = _firebase.getReference("  Section 1"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    if (b1.isChecked()) {
                        ...
                        map.put("session","1");
                        Toast.makeText(session1.this, "Submitted", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(session1.this, sections.class);
                    startActivity(i);
                }
            }
        });
