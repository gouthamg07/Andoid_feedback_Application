...
public class feedback_f extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference(" OB & HR"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference section = _firebase.getReference("  OB & HR"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference course = _firebase.getReference(" OB & HR"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    if (b1.isChecked()) {
                        ...
                        map.put("section", "A");
                        Toast.makeText(feedback_f.this, "Submitted", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(feedback_f.this, sections.class);
                    startActivity(i);
                }
            }
        });
