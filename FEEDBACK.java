...
public class FEEDBACK extends AppCompatActivity {
    ...
    private DatabaseReference feedback = _firebase.getReference("Business Analytics"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference section = _firebase.getReference("Business Analytics "+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
    private DatabaseReference course = _firebase.getReference("Business Analytics"+"/"+FirebaseAuth.getInstance().getCurrentUser().getUid());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lecturers.size() != 1) {
                    ...
                    Intent i = new Intent(FEEDBACK.this, sections.class);
                    startActivity(i);
                }
            }
        });
